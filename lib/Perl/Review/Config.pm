...
sub _find_profile {
    my $rc_file = '.perlreviewrc';

    #Check explicit setting
    return $ENV{PERLREVIEW} if $ENV{PERLREVIEW};
...
This class is used internally by L<Perl::Review>.  There is nothing to
see here (yet).
